#!/usr/bin/python3
# test_square.py
"""Define a test model class for square.py."""
import unittest
import io
import sys
...
class TestSquare_instantiation(unittest.TestCase):
    """Test an instanation for the unitest."""
...
class TestSquare_size(unittest.TestCase):
    """Test for square size test for the unittest."""
...
class TestSquare_x(unittest.TestCase):
    """Test doe an x corrredinate test."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Test for order of Square attribute."""
...
class TestSquare_area(unittest.TestCase):
    """Test for testing the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Test for string and display methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """Return a printed capture."""
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
            print(sq)
...
class TestSquare_update_args(unittest.TestCase):
    """Test for update args of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Test for update kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Test for testing to_dictionary method of the Square class."""
